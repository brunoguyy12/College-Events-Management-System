...
export default async function ProfilePage() {
  ...
  const breadcrumbItems = [{ title: "Dashboard", href: "/dashboard" }, { title: "Profile" }]
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-semibold">{user.name || "Complete your profile"}</h3>
              ...
              <div className="space-y-4 pt-4 border-t">
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div className="space-y-1">
                    <div className="text-2xl font-bold text-primary-600">{dbUser._count.registrations}</div>
                    <div className="text-xs text-muted-foreground">Events Joined</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-2xl font-bold text-secondary-600">{dbUser._count.organizedEvents}</div>
                    <div className="text-xs text-muted-foreground">Events Created</div>
                  </div>
                </div>
                <div className="text-center">
                  <div className="text-lg font-semibold text-accent-600">{dbUser._count.feedback}</div>
