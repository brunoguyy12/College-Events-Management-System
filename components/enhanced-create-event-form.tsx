...
interface EnhancedCreateEventFormProps {
  userId: string;
}

export function EnhancedCreateEventForm({
  userId,
}: EnhancedCreateEventFormProps) {
              ...
              <TabsContent value="basic" className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Upload a banner image for your event. If not provided, a
